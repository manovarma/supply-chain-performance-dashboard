...
## 🔍 Key Insights
- Higher discount bands are associated with lower average profit per order.
- Late deliveries are concentrated in specific regions and shipping modes.
- Some high-revenue categories contribute disproportionately to total profit.
- Shipping mode selection plays a significant role in delivery reliability.
